...
// Dialog component using Radix UI Primitives with Tailwind styling
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={`fixed z-50 grid w-full max-w-lg scale-100 gap-4 bg-white p-6 opacity-100 shadow-lg animate-in fade-in-90 slide-in-from-bottom-10 sm:rounded-lg sm:zoom-in-90 sm:slide-in-from-bottom-0 md:w-full ${className}`}
      {...props}
    >
      {children}
